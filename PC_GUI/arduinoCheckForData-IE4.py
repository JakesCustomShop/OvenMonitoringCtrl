...
def col_header_callback(num):
	...
	def get_name_and_close():
		...
		if col_header[num]:  # Check if user entered a name
			...
			edit_col_header_win.destroy()  # Close the window
		else:
...
def build_table(masterframe):
	...
	for num in range(1,9):
		...
		table.heading('temp{}'.format(num), text=col_header[num-1], command=lambda c=num: col_header_callback(c))
